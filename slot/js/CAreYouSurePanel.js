function CAreYouSurePanel() {
    ...
    this._init = function () {
        ...
        var oTitle = new CTLText(_oPanelContainer, 
                    -oSprite.width/2 +20, -oSprite.height/2 + 150, oSprite.width-40, 100, 
        ...
        _oButYes = new CGfxButton(130, 120, s_oSpriteLibrary.getSprite('but_yes'), _oPanelContainer);
        _oButYes.addEventListener(ON_MOUSE_UP, this._onButYes, this);

        _oButNo = new CGfxButton(-130, 120, s_oSpriteLibrary.getSprite('but_no'), _oPanelContainer);
